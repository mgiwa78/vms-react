...
export const SecurityNavContainer = styled.div`
  height: 100vh;
  ...
  position: fixed;
`;
export const SecurityNavTop = styled.div``;
export const SecurityNavList = styled.ul`
  margin: 0;
  background-color: #062132;
...
export const SettingsSvg = styled(SettingsIcon)`
  margin-right: 20px;
`;
export const SecurityNavItem = styled.li`
  color: #b5bcc2;
  font-size: 16px;
  height: inherit;
  font-weight: 500;
...
`;
export const SecurityNavLogo = styled.div`
