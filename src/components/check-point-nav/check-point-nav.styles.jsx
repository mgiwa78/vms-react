...
import { ReactComponent as CheckoutIcon } from "../../assets/svg/checkout2.svg";
...
export const CheckPointNavContainer = styled.div`
  ...
  position: fixed;
`;
export const CheckPointNavTop = styled.div``;
export const CheckPointNavList = styled.ul`
  margin: 0;
  background-color: #062132;
...
export const SettingsSvg = styled(SettingsIcon)`
  margin-right: 20px;
`;
export const CheckOutSvg = styled(CheckoutIcon)`
  margin-right: 20px;
`;
export const CheckInSvg = styled(CheckinIcon)`
  margin-right: 20px;
`;
export const CheckPointNavItem = styled.li`
  color: #b5bcc2;
  font-size: 16px;
  height: inherit;
  font-weight: 500;
...
`;
export const CheckPointNavLogo = styled.div`
